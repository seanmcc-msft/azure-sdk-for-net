...
namespace Azure.Storage.Files.DataLake
{
    ...
    internal static partial class DataLakeRestClient
    {
        ...
        public static partial class Path
        {
            ...
            #region Path.SetPermissionAsync
            /// <summary>
            /// Sets the permission on a path
            /// </summary>
            /// <param name="clientDiagnostics">The ClientDiagnostics instance used for operation reporting.</param>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="resourceUri">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            /// <param name="version">Specifies the version of the operation to use for this request.</param>
            /// <param name="setAclMode">Set ACL mode</param>
            /// <param name="timeout">The timeout parameter is expressed in seconds. For more information, see <a href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting Timeouts for Blob Service Operations.</a></param>
            /// <param name="requestId">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <param name="permissions">Optional and only valid if Hierarchical Namespace is enabled for the account. Sets POSIX access permissions for the file owner, the file owning group, and others. Each class may be granted read, write, or execute permission.  The sticky bit is also supported.  Both symbolic (rwxrw-rw-) and 4-digit octal notation (e.g. 0766) are supported.</param>
            /// <param name="owner">Optional. The owner of the blob or directory.</param>
            ...
            /// <param name="operationName">Operation name.</param>
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>Azure.Response{Azure.Storage.Files.DataLake.Models.PathSetPermissionResult}</returns>
            public static async System.Threading.Tasks.ValueTask<Azure.Response<Azure.Storage.Files.DataLake.Models.PathSetPermissionResult>> SetPermissionAsync(
                Azure.Core.Pipeline.ClientDiagnostics clientDiagnostics,
                Azure.Core.Pipeline.HttpPipeline pipeline,
                System.Uri resourceUri,
                string version,
                Azure.Storage.Files.DataLake.Models.PathSetAclMode setAclMode,
                int? timeout = default,
                string requestId = default,
                string permissions = default,
                string owner = default,
                string group = default,
                bool async = true,
                string operationName = "PathClient.SetPermission",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = clientDiagnostics.CreateScope(operationName);
                try
                {
                    _scope.AddAttribute("url", resourceUri);
                    _scope.Start();
                    using (Azure.Core.HttpMessage _message = SetPermissionAsync_CreateMessage(
                        pipeline,
                        resourceUri,
                        version,
                        setAclMode,
                        ...
                        group))
                    {
                        ...
                        Azure.Response _response = _message.Response;
                        cancellationToken.ThrowIfCancellationRequested();
                        return SetPermissionAsync_CreateResponse(clientDiagnostics, _response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the Path.SetPermissionAsync request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="resourceUri">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            /// <param name="version">Specifies the version of the operation to use for this request.</param>
            ...
            /// <param name="owner">Optional. The owner of the blob or directory.</param>
            /// <param name="group">Optional. The owning group of the blob or directory.</param>
            /// <returns>The Path.SetPermissionAsync Message.</returns>
            internal static Azure.Core.HttpMessage SetPermissionAsync_CreateMessage(
                Azure.Core.Pipeline.HttpPipeline pipeline,
                System.Uri resourceUri,
                string version,
                Azure.Storage.Files.DataLake.Models.PathSetAclMode setAclMode,
                ...
                string group = default)
            {
                ...
                // Add request headers
                _request.Headers.SetValue("x-ms-version", version);
                _request.Headers.SetValue("x-ms-acl-mode", setAclMode.ToString());
                if (requestId != null) { _request.Headers.SetValue("x-ms-client-request-id", requestId); }
                if (permissions != null) { _request.Headers.SetValue("x-ms-permissions", permissions); }
                if (owner != null) { _request.Headers.SetValue("x-ms-owner", owner); }
                if (group != null) { _request.Headers.SetValue("x-ms-group", group); }
            ...
            /// <summary>
            /// Create the Path.SetPermissionAsync response or throw a failure exception.
            /// </summary>
            /// <param name="clientDiagnostics">The ClientDiagnostics instance to use.</param>
            /// <param name="response">The raw Response.</param>
            /// <returns>The Path.SetPermissionAsync Azure.Response{Azure.Storage.Files.DataLake.Models.PathSetPermissionResult}.</returns>
            internal static Azure.Response<Azure.Storage.Files.DataLake.Models.PathSetPermissionResult> SetPermissionAsync_CreateResponse(
                Azure.Core.Pipeline.ClientDiagnostics clientDiagnostics,
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
                {
                    ...
                    {
                        // Create the result
                        Azure.Storage.Files.DataLake.Models.PathSetPermissionResult _value = new Azure.Storage.Files.DataLake.Models.PathSetPermissionResult();
            ...
            #endregion Path.SetPermissionAsync
        }
...
#region class PathSetPermissionResult
namespace Azure.Storage.Files.DataLake.Models
{
    /// <summary>
    /// Path SetPermissionResult
    /// </summary>
    public partial class PathSetPermissionResult
    {
        /// <summary>
        ...
        /// <summary>
        /// Prevent direct instantiation of PathSetPermissionResult instances.
        /// You can use DataLakeModelFactory.PathSetPermissionResult instead.
        /// </summary>
        internal PathSetPermissionResult() { }
    }
    ...
    {
        /// <summary>
        /// Creates a new PathSetPermissionResult instance for mocking.
        /// </summary>
        public static PathSetPermissionResult PathSetPermissionResult(
            Azure.ETag eTag,
            System.DateTimeOffset lastModified,
            string clientRequestId)
        {
            return new PathSetPermissionResult()
            {
                ETag = eTag,
...
#endregion class PathSetPermissionResult
