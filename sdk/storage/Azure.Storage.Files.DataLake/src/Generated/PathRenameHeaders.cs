...
{
    internal partial class PathRenameHeaders
    {
        private readonly Response _response;
        public PathRenameHeaders(Response response)
        {
            _response = response;
        }
        ...
        /// <summary> On successful rename, this header specifies the path the source was renamed to. Will never be different from x-ms-rename-destination header passed in the request. </summary>
        public string XMsRenameDestination => _response.Headers.TryGetValue("x-ms-rename-destination", out string value) ? value : null;
    }
}
