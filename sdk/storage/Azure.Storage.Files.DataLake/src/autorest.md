...
- from: swagger-document
  ...
  transform: >
    ...
    delete $.DestinationIfMatch["x-ms-parameter-grouping"];
    delete $.DestinationIfModifiedSince["x-ms-parameter-grouping"];
    delete $.DestinationIfNoneMatch["x-ms-parameter-grouping"];
    delete $.DestinationIfUnmodifiedSince["x-ms-parameter-grouping"];
